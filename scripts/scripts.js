...
var animClass = "showFade";

function toggleMobileMenu(bool)
{
	if(bool) { menuOpen = bool;} else { menuOpen = !menuOpen; } // manually set value or toggle
	if(menuOpen == true){
		menuFade.classList.add(animClass);
		hamburgerMenu.src = "img/icon-hamburger-close.png";
	} else {
		menuFade.classList.remove(animClass);
		hamburgerMenu.src = "img/icon-hamburger.png";
	}
}

window.addEventListener('resize', toggleMobileMenu, false); // close on window resize